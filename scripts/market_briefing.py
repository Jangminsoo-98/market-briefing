...
<div class="wrap">
  <header class="page">
    <p class="eyebrow">KOSPI · KOSDAQ · US MARKETS (LOCAL / FREE)</p>
    <h1 class="title">데일리 마켓 브리핑</h1>
    <p class="subtitle">이 PC의 작업 스케줄러가 평일 하루 세 번 자동 생성 · 06:00 전일 마감 요약 · 08:30 국내 지수·종목 오늘 전망 · 22:00 해외 지수·종목 오늘 전망 (마지막 갱신: {generated_at})</p>
  </header>
